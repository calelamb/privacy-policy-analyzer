    ...
    <main>
      ...
      <section className="bg-navy text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
          <p className="text-xs font-semibold uppercase tracking-[0.15em] text-byu-lightblue mb-4">
            Americas Conference on Information Systems 2026
          </p>
          <h1
          ...
          <p className="text-lg text-white/70 leading-relaxed max-w-2xl mb-8">
            An AI-driven analysis of privacy policies across nearly 1,700 educational
            applications, examining how well the industry safeguards children's data
            under COPPA and GDPR.
          </p>
